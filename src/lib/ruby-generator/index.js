...
import SmT1Blocks from './smt1.js';
import SmT2Blocks from './smt2.js';
import SmT3Blocks from './smt3.js';
...
SmT1Blocks(RubyGenerator);
SmT2Blocks(RubyGenerator);
SmT3Blocks(RubyGenerator);
